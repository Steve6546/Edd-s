...
```bash
git remote add encore encore://leap-app-ws82
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-ws82/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-ws82/settings/integrations/github)
